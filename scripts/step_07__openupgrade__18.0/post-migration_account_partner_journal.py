...
env.cr.execute("""
    ...
    WHERE table_name = 'res_partner' AND column_name = 'default_purchase_journal_id_temp'
""")
_temp_col_exists = bool(env.cr.fetchone())

if not _temp_col_exists:
    _logger.info("Column default_purchase_journal_id_temp not found in res_partner, skipping")
else:
